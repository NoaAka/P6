...
public class PlayerControlRTII : MonoBehaviour {
	...
	void FixedUpdate () {
		...
		*/
        ...
        transform.rotation = Quaternion.AngleAxis(connection.rotation, Vector3.up);
        /*
        targetDir = new Vector3(0f,connection.rotation,0f);
